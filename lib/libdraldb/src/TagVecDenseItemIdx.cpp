 ...
 * @return new object.
 */
TagVecDenseItemIdx::TagVecDenseItemIdx(TagVecItemIdx* ovec)
{
    ...
    valvec = new TagVecDenseItemIdxNode[nextEntry];
 ...
 */
TagVecDenseItemIdx::~TagVecDenseItemIdx()
{
    delete [] valvec;
}
...
/**
  ...
  */
ZipObject*
TagVecDenseItemIdx::compressYourSelf(INT32 cycle, bool last)
{
    return this;
}
...
/**
  ...
  */
void
TagVecDenseItemIdx::dumpCycleVector()
{
}
