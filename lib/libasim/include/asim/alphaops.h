...
/**
 * @file
 * @author Steve Jenness, Thomas Van Baak
 * @brief Alpha AXP instruction and floating constant definitions.
 */
...
#define ISA_EXTENSION	_01_OP	// - overloaded 0x1 for ISA extensions
...
#define FPOP2_OP        0x14    // move from fp reg to int reg
...
#define SEXT_OP         0x1C    // ALPHA_OPERATE or ALPHA_LITERAL
#define FPTI_OP         0x1C
...
//      LDx     Ra.wq,disp.ab(Rb.ab)            x = (B,W,L,Q,F,G,S,T)
...
typedef struct _Alpha_Memory_Special_Format {
        UINT32 MemDisp : 16;
        UINT32 Rb : 5;
        UINT32 Ra : 5;
        UINT32 Opcode : 6;
} Alpha_Memory_Special_Format;
...
#define ECB_FUNC          0xe800
#define WH64_FUNC         0xf800
#define WH64EN_FUNC       0xfc00
...
#define ECB_FUNC_STR       "ecb"
#define WH64_FUNC_STR      "wh64"
#define WH64EN_FUNC_STR    "wh64en"

//
...
typedef struct _Alpha_OpReg_Format {
        UINT32 Rc : 5;
        UINT32 Function : 7;
        UINT32 RbvType : 1;              // 0 for register format
        UINT32 SBZ : 3;
        UINT32 Rb : 5;
        UINT32 Ra : 5;
        UINT32 Opcode : 6;
...
typedef struct _Alpha_OpLit_Format {
        UINT32 Rc : 5;
        UINT32 Function : 7;
        UINT32 RbvType : 1;              // 1 for literal format
        UINT32 Literal : 8;
        UINT32 Ra : 5;
        UINT32 Opcode : 6;
} Alpha_OpLit_Format;
...
#define AMASK_FUNC      0x61
#define IMPLVER_FUNC    0x6c
...
#define AMASK_FUNC_STR      "amask"
#define IMPLVER_FUNC_STR    "implver"
...
#define CTLZ_FUNC       0x32    // Count leading zero
#define CTPOP_FUNC      0x30    // Count population
#define CTTZ_FUNC       0x33    // Count trailing zero

#define FTOIS_FUNC      0x78    // float to int move, s_floating
#define FTOIT_FUNC      0x70    // float to int move, T_floating

#define MAXSB8_FUNC     0x3e
#define MAXSW4_FUNC     0x3f
#define MAXUB8_FUNC     0x3c
#define MAXUW4_FUNC     0x3d
#define MINSB8_FUNC     0x38
#define MINSW4_FUNC     0x39
#define MINUB8_FUNC     0x3a
#define MINUW4_FUNC     0x3b

#define PERR_FUNC       0x31
#define PKLB_FUNC       0x37
#define PKWB_FUNC       0x36

#define UNPKBL_FUNC     0x35
#define UNPKBW_FUNC     0x34
...
#define FTOIS_FUNC_STR   "ftois"
#define FTOIT_FUNC_STR   "ftoit"

#define MAXSB8_FUNC_STR  "maxsb8" 
#define MAXSW4_FUNC_STR  "maxsw4"
#define MAXUB8_FUNC_STR  "maxub8"
#define MAXUW4_FUNC_STR  "maxuw4"
#define MINSB8_FUNC_STR  "minsb8"
#define MINSW4_FUNC_STR  "minsw4"
#define MINUB8_FUNC_STR  "minub8"
#define MINUW4_FUNC_STR  "minuw4"

#define PERR_FUNC_STR    "perr"
#define PKLB_FUNC_STR    "pklb"
#define PKWB_FUNC_STR    "pkwb"

#define UNPKBL_FUNC_STR  "unpkbl"
#define UNPKBW_FUNC_STR  "unpkbw"
...
//
// FPOP2 function codes without flags (in Function, Opcode 14)

#define ITOFF_FUNC          0x14
#define ITOFS_FUNC          0x04
#define ITOFT_FUNC          0x24

#define SQRTF_FUNC          0x0a
#define SQRTG_FUNC          0x2a
#define SQRTS_FUNC          0x0b
#define SQRTT_FUNC          0x2b

#define ITOFF_FUNC_STR      "itoff"
#define ITOFS_FUNC_STR      "itofs"
#define ITOFT_FUNC_STR      "itoft"
#define SQRTF_FUNC_STR      "sqrtf"
#define SQRTG_FUNC_STR      "sqrtg"
#define SQRTS_FUNC_STR      "sqrts"
#define SQRTT_FUNC_STR      "sqrtt"
...

// Type (01) Alpha ISA Extension
//
//  3         2 2         2 1                                     0
//  1         6 5         0 9                                     0
// +-----------+-----------+---------------------------------------+
// |   opcode  | Extension |              SBZ                      |
// +-----------+-----------+---------------------------------------+

typedef struct _Alpha_ISA_Extension_Format {
        UINT32 SBZ : 20;
        UINT32 ExtCode : 6;
        UINT32 Opcode : 6;
} Alpha_ISA_Extension_Format;

#define TTL_EXT    0x00      // Tarantula ISA Extension
#define TLDS_EXT   0x01      // Thread Level Data Speculation ISA Extension
#define LAST_EXT   TLDS_EXT  // This is the last ISA extension!!!

//
//
//
typedef union _Alpha_Instruction {
        ...
        Alpha_Memory_Special_Format MemSpc;
        ...
        Alpha_ISA_Extension_Format ExtISA;
...
#define F2_REG      2       // Saved register
#define F3_REG      3       // Saved register
#define F4_REG      4       // Saved register
#define F5_REG      5       // Saved register
#define F6_REG      6       // Saved register
#define F7_REG      7       // Saved register
#define F8_REG      8       // Saved register
#define F9_REG      9       // Saved register
#define F10_REG     10      // Scratch register
#define F11_REG     11      // Scratch register
#define F12_REG     12      // Scratch register
#define F13_REG     13      // Scratch register
#define F14_REG     14      // Scratch register
#define F15_REG     15      // Scratch register
#define F16_REG     16      // floating argument register
#define F17_REG     17      // floating argument register
#define F18_REG     18      // floating argument register
#define F19_REG     19      // floating argument register
#define F20_REG     20      // floating argument register
#define F21_REG     21      // floating argument register
#define F22_REG     22      // Scratch register
#define F23_REG     23      // Scratch register
#define F24_REG     24      // Scratch register
#define F25_REG     25      // Scratch register
#define F26_REG     26      // Scratch register
#define F27_REG     27      // Scratch register
#define F28_REG     28      // Scratch register
#define F29_REG     29      // Scratch register
#define F30_REG     30      // Scratch register
...
#define double_MAXIMUM_VALUE        ((UINT64)0x7fefffffffffffff)
#define double_INFINITY_VALUE       ((UINT64)0x7ff0000000000000)
#define double_QUIET_NAN_VALUE      ((UINT64)0xfff8000000000000)
...
#define FP_COMPARE_true             ((UINT64)0x4000000000000000)
#define FP_COMPARE_false            ((UINT64)0x0000000000000000)
